...
static STK_T _kernel_stack_TSKID_1_1[COUNT_STK_T(2048)] __attribute__((section(".stack_CLS_ALL_PRC1"),nocommon));
static STK_T _kernel_stack_TSKID_2_1[COUNT_STK_T(2048)] __attribute__((section(".stack_CLS_ALL_PRC2"),nocommon));
const TINIB _kernel_tinib_table[TNUM_TSKID] = {
	...
	{ (TA_ACT), (EXINF)(0), (TASK)(tecs_rust_start_r_processor1_symmetric__task1_1), INT_PRIORITY(7), ROUND_STK_T(2048), _kernel_stack_TSKID_1_1, 1, 0x3 },
	{ (TA_ACT), (EXINF)(0), (TASK)(tecs_rust_start_r_processor2_symmetric__task2_1), INT_PRIORITY(7), ROUND_STK_T(2048), _kernel_stack_TSKID_2_1, 2, 0x3 }
};
