...
#[link_section = ".rodata"]
pub static RPROCESSOR2SYMMETRIC_DATAQUEUELED: TDataqueueRs = TDataqueueRs {
...
#[link_section = ".rodata"]
pub static EINOTIFICATIONHANDLERFORRPROCESSOR2SYMMETRIC_DATAQUEUELED: EiNotificationHandlerForTDataqueueRs = EiNotificationHandlerForTDataqueueRs {
	cell: &RPROCESSOR2SYMMETRIC_DATAQUEUELED,
};
