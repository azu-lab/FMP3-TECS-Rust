...
struct tag_siKernel_VMT {
    ...
    ER             (*multiRotateReadyQueue__T)( const struct tag_siKernel_VDES *edp, ID domainId, PRI taskPriority );
...
#define	FUNCID_SIKERNEL_MULTIROTATEREADYQUEUE  (3)
#define	FUNCID_SIKERNEL_GETTASKID              (4)
#define	FUNCID_SIKERNEL_LOCKCPU                (5)
#define	FUNCID_SIKERNEL_UNLOCKCPU              (6)
...
#define	FUNCID_SIKERNEL_EXITKERNEL             (12)
#define	FUNCID_SIKERNEL_EXCEPTIONSENSEDISPATCHPENDINGSTATE (13)
