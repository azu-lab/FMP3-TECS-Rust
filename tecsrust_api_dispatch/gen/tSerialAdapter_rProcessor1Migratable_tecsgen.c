...
extern struct tag_sSerialPort_VDES rProcessor1Migratable_SerialPort1_SerialPortMain_eSerialPort_des;

/* call port array #_CPA_# */
struct tag_sSerialPort_VDES * const rProcessor1Migratable_SerialAdapter_cSerialPort[] = {
    &rProcessor1Migratable_SerialPort1_SerialPortMain_eSerialPort_des,
};
...
{
    /* call port (INIB) #_CP_# */ 
    rProcessor1Migratable_SerialAdapter_cSerialPort, /* #_CCP3B_# */
