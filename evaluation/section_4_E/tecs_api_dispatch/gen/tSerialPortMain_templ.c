...
#warning "'eSerialPort_open' needs to be edited."   /* delete this line after edit */
...
eSerialPort_close(CELLIDX idx)
{
	...
	/* Put statements here #_TEFB_# */
#warning "'eSerialPort_close' needs to be edited."   /* delete this line after edit */
...
eSerialPort_read(CELLIDX idx, char* buffer, uint_t length)
{
	...
	/* Put statements here #_TEFB_# */
#warning "'eSerialPort_read' needs to be edited."   /* delete this line after edit */
...
eSerialPort_write(CELLIDX idx, const char* buffer, uint_t length)
{
	...
	/* Put statements here #_TEFB_# */
#warning "'eSerialPort_write' needs to be edited."   /* delete this line after edit */
...
eSerialPort_control(CELLIDX idx, uint_t ioControl)
{
	...
	/* Put statements here #_TEFB_# */
#warning "'eSerialPort_control' needs to be edited."   /* delete this line after edit */
...
eSerialPort_refer(CELLIDX idx, T_SERIAL_RPOR* pk_rpor)
{
	...
	/* Put statements here #_TEFB_# */
#warning "'eSerialPort_refer' needs to be edited."   /* delete this line after edit */
...
enSerialPortManage_getChar(CELLIDX idx, char* p_char)
{
	...
	/* Put statements here #_TEFB_# */
#warning "'enSerialPortManage_getChar' needs to be edited."   /* delete this line after edit */
...
eiSIOCBR_readySend(CELLIDX idx)
{
	...
	/* Put statements here #_TEFB_# */
#warning "'eiSIOCBR_readySend' needs to be edited."   /* delete this line after edit */
...
eiSIOCBR_readyReceive(CELLIDX idx)
{
	...
	/* Put statements here #_TEFB_# */
#warning "'eiSIOCBR_readyReceive' needs to be edited."   /* delete this line after edit */
