...
const TINIB _kernel_tinib_table[TNUM_TSKID] = {
	...
	{ (TA_ACT), (EXINF)(0), (TASK)(tecs_rust_start_r_processor1_symmetric_task1_1), INT_PRIORITY(4), ROUND_STK_T(2048), _kernel_stack_TSKID_1_1, 1, 0x1 },
	{ (TA_NULL), (EXINF)(0), (TASK)(tecs_rust_start_r_processor_all_mig_taskmig), INT_PRIORITY(6), ROUND_STK_T(2048), _kernel_stack_TSKID_MIG, 1, 0x3 },
	{ (TA_ACT), (EXINF)(0), (TASK)(tecs_rust_start_r_processor2_symmetric_task2_1), INT_PRIORITY(7), ROUND_STK_T(2048), _kernel_stack_TSKID_2_1, 2, 0x2 },
	{ (TA_NULL), (EXINF)(0), (TASK)(tecs_rust_start_r_processor2_symmetric_task2_2), INT_PRIORITY(10), ROUND_STK_T(2048), _kernel_stack_TSKID_2_2, 2, 0x2 }
};
