...
static STK_T _kernel_stack_TSKID_tTask_rProcessor2Symmetric_Task2_1[COUNT_STK_T(STACK_SIZE)] __attribute__((section(".stack_CLS_ALL_PRC2"),nocommon));
static STK_T _kernel_stack_TSKID_tTask_rProcessor2Symmetric_Task2_2[COUNT_STK_T(STACK_SIZE)] __attribute__((section(".stack_CLS_ALL_PRC2"),nocommon));
...
static STK_T _kernel_stack_TSKID_tTask_rProcessor1Migratable_Task2_3[COUNT_STK_T(STACK_SIZE)] __attribute__((section(".stack_CLS_ALL_PRC1"),nocommon));
...
static STK_T _kernel_stack_TSKID_tTask_rProcessor1Migratable_ExceptionTask[COUNT_STK_T(STACK_SIZE)] __attribute__((section(".stack_CLS_ALL_PRC1"),nocommon));
...
static STK_T _kernel_stack_TSKID_tTask_rProcessor2Symmetric_ExceptionTask2[COUNT_STK_T(STACK_SIZE)] __attribute__((section(".stack_CLS_ALL_PRC2"),nocommon));
...
const TINIB _kernel_tinib_table[TNUM_TSKID] = {
	...
	{ (TA_NULL), (EXINF)((intptr_t)&rProcessor2Symmetric_Task2_1_INIB), (TASK)(tTask_start), INT_PRIORITY(MID_PRIORITY), ROUND_STK_T(STACK_SIZE), _kernel_stack_TSKID_tTask_rProcessor2Symmetric_Task2_1, 2, 0x3 },
	{ (TA_NULL), (EXINF)((intptr_t)&rProcessor2Symmetric_Task2_2_INIB), (TASK)(tTask_start), INT_PRIORITY(MID_PRIORITY), ROUND_STK_T(STACK_SIZE), _kernel_stack_TSKID_tTask_rProcessor2Symmetric_Task2_2, 2, 0x3 },
	...
	{ (TA_NULL), (EXINF)((intptr_t)&rProcessor1Migratable_Task2_3_INIB), (TASK)(tTask_start), INT_PRIORITY(MID_PRIORITY), ROUND_STK_T(STACK_SIZE), _kernel_stack_TSKID_tTask_rProcessor1Migratable_Task2_3, 1, 0x3 },
	...
	{ (TA_NULL), (EXINF)((intptr_t)&rProcessor1Migratable_ExceptionTask_INIB), (TASK)(tTask_start), INT_PRIORITY(EXC_PRIORITY), ROUND_STK_T(STACK_SIZE), _kernel_stack_TSKID_tTask_rProcessor1Migratable_ExceptionTask, 1, 0x3 },
	...
	{ (TA_NULL), (EXINF)((intptr_t)&rProcessor2Symmetric_ExceptionTask2_INIB), (TASK)(tTask_start), INT_PRIORITY(EXC_PRIORITY), ROUND_STK_T(STACK_SIZE), _kernel_stack_TSKID_tTask_rProcessor2Symmetric_ExceptionTask2, 2, 0x3 },
...
static TCB _kernel_tcb_TSKID_tTask_rProcessor2Symmetric_Task2_1 __attribute__((section(".kernel_data_CLS_ALL_PRC2"),nocommon));
static TCB _kernel_tcb_TSKID_tTask_rProcessor2Symmetric_Task2_2 __attribute__((section(".kernel_data_CLS_ALL_PRC2"),nocommon));
static TCB _kernel_tcb_TSKID_tTask_rProcessor2Symmetric_Task3 __attribute__((section(".kernel_data_CLS_ALL_PRC2"),nocommon));
static TCB _kernel_tcb_TSKID_tTask_rProcessor1Migratable_Task2_3 __attribute__((section(".kernel_data_CLS_ALL_PRC1"),nocommon));
...
static TCB _kernel_tcb_TSKID_tTask_rProcessor1Migratable_ExceptionTask __attribute__((section(".kernel_data_CLS_ALL_PRC1"),nocommon));
...
static TCB _kernel_tcb_TSKID_tTask_rProcessor2Symmetric_ExceptionTask2 __attribute__((section(".kernel_data_CLS_ALL_PRC2"),nocommon));
...
TCB	*const _kernel_p_tcb_table[TNUM_TSKID] = {
	...
	&_kernel_tcb_TSKID_tTask_rProcessor2Symmetric_Task2_1,
	&_kernel_tcb_TSKID_tTask_rProcessor2Symmetric_Task2_2,
	&_kernel_tcb_TSKID_tTask_rProcessor2Symmetric_Task3,
	&_kernel_tcb_TSKID_tTask_rProcessor1Migratable_Task2_3,
	&_kernel_tcb_TSKID_tTask_rProcessor1Migratable_MainTask,
	&_kernel_tcb_TSKID_tTask_rProcessor1Migratable_ExceptionTask,
	&_kernel_tcb_TSKID_tTask_rProcessor2Symmetric_MainTask2,
	&_kernel_tcb_TSKID_tTask_rProcessor2Symmetric_ExceptionTask2,
	&_kernel_tcb_TSKID_tTask_rProcessor1Migratable_LogTask_Task
};

const ID _kernel_torder_table[TNUM_TSKID] = { 
	TSKID_tTask_rProcessor1Migratable_Task1, TSKID_tTask_rProcessor1Migratable_Task2, TSKID_tTask_rProcessor2Symmetric_Task2_1, TSKID_tTask_rProcessor2Symmetric_Task2_2, TSKID_tTask_rProcessor2Symmetric_Task3, TSKID_tTask_rProcessor1Migratable_Task2_3, TSKID_tTask_rProcessor1Migratable_MainTask, TSKID_tTask_rProcessor1Migratable_ExceptionTask, TSKID_tTask_rProcessor2Symmetric_MainTask2, TSKID_tTask_rProcessor2Symmetric_ExceptionTask2, TSKID_tTask_rProcessor1Migratable_LogTask_Task
};
...
const CYCINIB _kernel_cycinib_table[TNUM_CYCID] = {
	{ (TA_NULL), (intptr_t)(tTimeEventHandler_tCyclicNotifier_tSample2_eiCyclicHandler_0_arg), (NFYHDR)(tTimeEventHandler_tCyclicNotifier_tSample2_eiCyclicHandler_0_fp), (2000000), (0), 2, 0x3 },
	{ (TA_NULL), (intptr_t)(tTimeEventHandler_tCyclicNotifier_tSample2_eiCyclicHandler_1_arg), (NFYHDR)(tTimeEventHandler_tCyclicNotifier_tSample2_eiCyclicHandler_1_fp), (2000000), (0), 1, 0x3 }
};
...
const ALMINIB _kernel_alminib_table[TNUM_ALMID] = {
	{ (TA_NULL), (intptr_t)(tTimeEventHandler_tAlarmNotifier_tSample2_eiAlarmHandler_0_arg), (NFYHDR)(tTimeEventHandler_tAlarmNotifier_tSample2_eiAlarmHandler_0_fp), 2, 0x3 },
	{ (TA_NULL), (intptr_t)(tTimeEventHandler_tAlarmNotifier_tSample2_eiAlarmHandler_1_arg), (NFYHDR)(tTimeEventHandler_tAlarmNotifier_tSample2_eiAlarmHandler_1_fp), 1, 0x3 }
};
...
{
	LOG_ISR_ENTER(ISRID_tISR_rProcessor1Migratable_InterruptServiceRoutine);
	((ISR)(tISR_start))((EXINF)(&rProcessor1Migratable_InterruptServiceRoutine_INIB));
	LOG_ISR_LEAVE(ISRID_tISR_rProcessor1Migratable_InterruptServiceRoutine);
}

void
_kernel_inthdr_36(void)
{
	LOG_ISR_ENTER(ISRID_tISR_rProcessor2Symmetric_InterruptServiceRoutine2);
	((ISR)(tISR_start))((EXINF)(&rProcessor2Symmetric_InterruptServiceRoutine2_INIB));
	LOG_ISR_LEAVE(ISRID_tISR_rProcessor2Symmetric_InterruptServiceRoutine2);
}
...
_kernel_inthdr_82(void)
{
	...
	((ISR)(tISR_start))((EXINF)(&rProcessor1Migratable_SIOPortTarget1_ISRInstance_INIB));
	LOG_ISR_LEAVE(ISRID_tISR_rProcessor1Migratable_SIOPortTarget1_ISRInstance);
}

#define TNUM_CFG_INTNO	11
...
const INTINIB _kernel_intinib_table[TNUM_CFG_INTNO] = {
	...
	{ (INTNO1), (INTNO1_INTATR), (INTNO1_INTPRI), 1, 0x1U },
	{ (INTNO2), (INTNO2_INTATR), (INTNO2_INTPRI), 2, 0x2U },
...
const FP _kernel_inh_table_prc1[96] = {
	...
	/* 0x10023 */ (FP)(_kernel_inthdr_35),
	/* 0x10024 */ (FP)(_kernel_inthdr_36),
...
const FP _kernel_inh_table_prc2[96] = {
	...
	/* 0x20023 */ (FP)(_kernel_inthdr_35),
	/* 0x20024 */ (FP)(_kernel_inthdr_36),
...
const FP _kernel_exc_table_prc1[7] = {
	/* 0x10000 */ (FP)(tCpuExceptionHandler_rProcessor1Migratable_CpuExceptionHandler_start),
...
const FP _kernel_exc_table_prc2[7] = {
	/* 0x20000 */ (FP)(tCpuExceptionHandler_rProcessor2Symmetric_CpuExceptionHandler2_start),
