...
Inline ER           tTask_eTask_migrateAndActivate(tTask_IDX idx, ID prcid);
Inline ER_UINT      tTask_eTask_cancelActivate(tTask_IDX idx);
Inline ER           tTask_eTask_migrate(tTask_IDX idx, ID prcid);
...
Inline ER           tTask_eTask_changeSubPriority(tTask_IDX idx, uint_t subPriority);
...
#define tTask_N_CELL               (11)  /*  number of cells  #_NCEL_# */
...
#define eTask_migrateAndActivate tTask_eTask_migrateAndActivate
#define eTask_cancelActivate tTask_eTask_cancelActivate
#define eTask_migrate    tTask_eTask_migrate
#define eTask_getTaskState tTask_eTask_getTaskState
#define eTask_changePriority tTask_eTask_changePriority
#define eTask_changeSubPriority tTask_eTask_changeSubPriority
