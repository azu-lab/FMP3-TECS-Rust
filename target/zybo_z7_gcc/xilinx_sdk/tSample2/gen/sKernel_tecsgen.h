...
struct tag_sKernel_VMT {
    ...
    ER             (*multiRotateReadyQueue__T)( const struct tag_sKernel_VDES *edp, ID domainId, PRI taskPriority );
    ...
    ER             (*multiGetLoad__T)( const struct tag_sKernel_VDES *edp, ID domainId, PRI taskPriority, uint_t* p_load );
    ER             (*getNthTask__T)( const struct tag_sKernel_VDES *edp, PRI taskPriority, uint_t nth, ID* p_taskID );
    ER             (*multiGetNthTask__T)( const struct tag_sKernel_VDES *edp, ID domainId, PRI taskPriority, uint_t nth, ID* p_taskID );
    ...
    ER             (*getProcessorID__T)( const struct tag_sKernel_VDES *edp, ID* p_prcid );
};
...
#define	FUNCID_SKERNEL_MULTIROTATEREADYQUEUE   (14)
#define	FUNCID_SKERNEL_GETTASKID               (15)
#define	FUNCID_SKERNEL_GETLOAD                 (16)
#define	FUNCID_SKERNEL_MULTIGETLOAD            (17)
#define	FUNCID_SKERNEL_GETNTHTASK              (18)
#define	FUNCID_SKERNEL_MULTIGETNTHTASK         (19)
#define	FUNCID_SKERNEL_LOCKCPU                 (20)
#define	FUNCID_SKERNEL_UNLOCKCPU               (21)
#define	FUNCID_SKERNEL_DISABLEDISPATCH         (22)
#define	FUNCID_SKERNEL_ENABLEDISPATCH          (23)
#define	FUNCID_SKERNEL_SENSECONTEXT            (24)
#define	FUNCID_SKERNEL_SENSELOCK               (25)
#define	FUNCID_SKERNEL_SENSEDISPATCH           (26)
#define	FUNCID_SKERNEL_SENSEDISPATCHPENDINGSTATE (27)
#define	FUNCID_SKERNEL_SENSEKERNEL             (28)
#define	FUNCID_SKERNEL_EXITKERNEL              (29)
#define	FUNCID_SKERNEL_CHANGEINTERRUPTPRIORITYMASK (30)
#define	FUNCID_SKERNEL_GETINTERRUPTPRIORITYMASK (31)
#define	FUNCID_SKERNEL_GETPROCESSORID          (32)
