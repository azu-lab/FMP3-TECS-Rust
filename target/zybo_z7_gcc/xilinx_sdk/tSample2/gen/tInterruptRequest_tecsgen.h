...
#define tInterruptRequest_CB_ptab           tInterruptRequest_INIB_ptab
...
extern tInterruptRequest_INIB  *const tInterruptRequest_INIB_ptab[];
...
#define tInterruptRequest_N_CELL        (3)  /*  number of cells  #_NCEL_# */
...
#define FOREACH_CELL(i,p_cb)   \
    for( (i) = 0; (i) < tInterruptRequest_N_CELL; (i)++ ){ \
       (p_cb) = tInterruptRequest_CB_ptab[i];
