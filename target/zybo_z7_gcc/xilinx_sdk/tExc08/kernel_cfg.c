...
static STK_T _kernel_stack_TSKID_tTask_rProcessor1Migratable_Task1[COUNT_STK_T(STACK_SIZE)] __attribute__((section(".stack_CLS_ALL_PRC1"),nocommon));
static STK_T _kernel_stack_TSKID_tTask_rProcessor1Migratable_Task2[COUNT_STK_T(STACK_SIZE)] __attribute__((section(".stack_CLS_ALL_PRC1"),nocommon));
static STK_T _kernel_stack_TSKID_tTask_rProcessor2Symmetric_Task3[COUNT_STK_T(STACK_SIZE)] __attribute__((section(".stack_CLS_ALL_PRC2"),nocommon));
static STK_T _kernel_stack_TSKID_tTask_rProcessor2Symmetric_Task4[COUNT_STK_T(STACK_SIZE)] __attribute__((section(".stack_CLS_ALL_PRC2"),nocommon));
static STK_T _kernel_stack_TSKID_tTask_rProcessor1Migratable_MainTask[COUNT_STK_T(STACK_SIZE)] __attribute__((section(".stack_CLS_ALL_PRC1"),nocommon));
static STK_T _kernel_stack_TSKID_tTask_rProcessor2Symmetric_MainTask2[COUNT_STK_T(STACK_SIZE)] __attribute__((section(".stack_CLS_ALL_PRC2"),nocommon));
...
static STK_T _kernel_stack_TSKID_tTask_rProcessor1Migratable_RPCPlugin__0_RPCChannel_ServerSide_Task[COUNT_STK_T(4096)] __attribute__((section(".stack_CLS_ALL_PRC1"),nocommon));
static STK_T _kernel_stack_TSKID_tTask_rProcessor2Symmetric_RPCPlugin__1_RPCChannel_ServerSide_Task[COUNT_STK_T(4096)] __attribute__((section(".stack_CLS_ALL_PRC2"),nocommon));
const TINIB _kernel_tinib_table[TNUM_TSKID] = {
	{ (TA_NULL), (EXINF)((intptr_t)&rProcessor1Migratable_Task1_INIB), (TASK)(tTask_start), INT_PRIORITY(MID_PRIORITY), ROUND_STK_T(STACK_SIZE), _kernel_stack_TSKID_tTask_rProcessor1Migratable_Task1, 1, 0x3 },
	{ (TA_NULL), (EXINF)((intptr_t)&rProcessor1Migratable_Task2_INIB), (TASK)(tTask_start), INT_PRIORITY(MID_PRIORITY), ROUND_STK_T(STACK_SIZE), _kernel_stack_TSKID_tTask_rProcessor1Migratable_Task2, 1, 0x3 },
	{ (TA_NULL), (EXINF)((intptr_t)&rProcessor2Symmetric_Task3_INIB), (TASK)(tTask_start), INT_PRIORITY(MID_PRIORITY), ROUND_STK_T(STACK_SIZE), _kernel_stack_TSKID_tTask_rProcessor2Symmetric_Task3, 2, 0x3 },
	{ (TA_NULL), (EXINF)((intptr_t)&rProcessor2Symmetric_Task4_INIB), (TASK)(tTask_start), INT_PRIORITY(MID_PRIORITY), ROUND_STK_T(STACK_SIZE), _kernel_stack_TSKID_tTask_rProcessor2Symmetric_Task4, 2, 0x3 },
	{ (TA_ACT), (EXINF)((intptr_t)&rProcessor1Migratable_MainTask_INIB), (TASK)(tTask_start), INT_PRIORITY(MAIN_PRIORITY), ROUND_STK_T(STACK_SIZE), _kernel_stack_TSKID_tTask_rProcessor1Migratable_MainTask, 1, 0x3 },
	{ (TA_ACT), (EXINF)((intptr_t)&rProcessor2Symmetric_MainTask2_INIB), (TASK)(tTask_start), INT_PRIORITY(MAIN_PRIORITY), ROUND_STK_T(STACK_SIZE), _kernel_stack_TSKID_tTask_rProcessor2Symmetric_MainTask2, 2, 0x3 },
	{ (TA_ACT), (EXINF)((intptr_t)&rProcessor1Migratable_LogTask_Task_INIB), (TASK)(tTask_start), INT_PRIORITY(3), ROUND_STK_T(4096), _kernel_stack_TSKID_tTask_rProcessor1Migratable_LogTask_Task, 1, 0x3 },
	{ (TA_ACT), (EXINF)((intptr_t)&rProcessor1Migratable_RPCPlugin__0_RPCChannel_ServerSide_Task_INIB), (TASK)(tTask_start), INT_PRIORITY(8), ROUND_STK_T(4096), _kernel_stack_TSKID_tTask_rProcessor1Migratable_RPCPlugin__0_RPCChannel_ServerSide_Task, 1, 0x3 },
	{ (TA_ACT), (EXINF)((intptr_t)&rProcessor2Symmetric_RPCPlugin__1_RPCChannel_ServerSide_Task_INIB), (TASK)(tTask_start), INT_PRIORITY(8), ROUND_STK_T(4096), _kernel_stack_TSKID_tTask_rProcessor2Symmetric_RPCPlugin__1_RPCChannel_ServerSide_Task, 2, 0x3 }
};

static TCB _kernel_tcb_TSKID_tTask_rProcessor1Migratable_Task1 __attribute__((section(".kernel_data_CLS_ALL_PRC1"),nocommon));
static TCB _kernel_tcb_TSKID_tTask_rProcessor1Migratable_Task2 __attribute__((section(".kernel_data_CLS_ALL_PRC1"),nocommon));
static TCB _kernel_tcb_TSKID_tTask_rProcessor2Symmetric_Task3 __attribute__((section(".kernel_data_CLS_ALL_PRC2"),nocommon));
static TCB _kernel_tcb_TSKID_tTask_rProcessor2Symmetric_Task4 __attribute__((section(".kernel_data_CLS_ALL_PRC2"),nocommon));
static TCB _kernel_tcb_TSKID_tTask_rProcessor1Migratable_MainTask __attribute__((section(".kernel_data_CLS_ALL_PRC1"),nocommon));
static TCB _kernel_tcb_TSKID_tTask_rProcessor2Symmetric_MainTask2 __attribute__((section(".kernel_data_CLS_ALL_PRC2"),nocommon));
...
static TCB _kernel_tcb_TSKID_tTask_rProcessor1Migratable_RPCPlugin__0_RPCChannel_ServerSide_Task __attribute__((section(".kernel_data_CLS_ALL_PRC1"),nocommon));
static TCB _kernel_tcb_TSKID_tTask_rProcessor2Symmetric_RPCPlugin__1_RPCChannel_ServerSide_Task __attribute__((section(".kernel_data_CLS_ALL_PRC2"),nocommon));

TCB	*const _kernel_p_tcb_table[TNUM_TSKID] = {
	&_kernel_tcb_TSKID_tTask_rProcessor1Migratable_Task1,
	&_kernel_tcb_TSKID_tTask_rProcessor1Migratable_Task2,
	&_kernel_tcb_TSKID_tTask_rProcessor2Symmetric_Task3,
	&_kernel_tcb_TSKID_tTask_rProcessor2Symmetric_Task4,
	&_kernel_tcb_TSKID_tTask_rProcessor1Migratable_MainTask,
	&_kernel_tcb_TSKID_tTask_rProcessor2Symmetric_MainTask2,
	&_kernel_tcb_TSKID_tTask_rProcessor1Migratable_LogTask_Task,
	&_kernel_tcb_TSKID_tTask_rProcessor1Migratable_RPCPlugin__0_RPCChannel_ServerSide_Task,
	&_kernel_tcb_TSKID_tTask_rProcessor2Symmetric_RPCPlugin__1_RPCChannel_ServerSide_Task
};

const ID _kernel_torder_table[TNUM_TSKID] = { 
	TSKID_tTask_rProcessor1Migratable_Task1, TSKID_tTask_rProcessor1Migratable_Task2, TSKID_tTask_rProcessor2Symmetric_Task3, TSKID_tTask_rProcessor2Symmetric_Task4, TSKID_tTask_rProcessor1Migratable_MainTask, TSKID_tTask_rProcessor2Symmetric_MainTask2, TSKID_tTask_rProcessor1Migratable_LogTask_Task, TSKID_tTask_rProcessor1Migratable_RPCPlugin__0_RPCChannel_ServerSide_Task, TSKID_tTask_rProcessor2Symmetric_RPCPlugin__1_RPCChannel_ServerSide_Task
};
...
static SEMCB _kernel_semcb_SEMID_tSemaphore_rProcessor1Migratable_RPCPlugin__0_RPCChannel_ClientSide_Semaphore __attribute__((section(".kernel_data_CLS_ALL_PRC1"),nocommon));
static SEMCB _kernel_semcb_SEMID_tSemaphore_rProcessor2Symmetric_RPCPlugin__1_RPCChannel_ClientSide_Semaphore __attribute__((section(".kernel_data_CLS_ALL_PRC2"),nocommon));
...
SEMCB	*const _kernel_p_semcb_table[TNUM_SEMID] = {
	...
	&_kernel_semcb_SEMID_tSemaphore_rProcessor1Migratable_RPCPlugin__0_RPCChannel_ClientSide_Semaphore,
	&_kernel_semcb_SEMID_tSemaphore_rProcessor2Symmetric_RPCPlugin__1_RPCChannel_ClientSide_Semaphore
};
...
static FLGCB _kernel_flgcb_FLGID_tEventflag_rProcessor1Migratable_RPCPlugin__0_Channel_Eventflag __attribute__((section(".kernel_data_CLS_ALL_PRC1"),nocommon));
static FLGCB _kernel_flgcb_FLGID_tEventflag_rProcessor2Symmetric_RPCPlugin__1_Channel_Eventflag __attribute__((section(".kernel_data_CLS_ALL_PRC2"),nocommon));

FLGCB	*const _kernel_p_flgcb_table[TNUM_FLGID] = {
	&_kernel_flgcb_FLGID_tEventflag_rProcessor1Migratable_RPCPlugin__0_Channel_Eventflag,
	&_kernel_flgcb_FLGID_tEventflag_rProcessor2Symmetric_RPCPlugin__1_Channel_Eventflag
};
...
static DTQMB _kernel_dtqmb_DTQID_tDataqueue_rProcessor1Migratable_RPCPlugin__0_Channel_Dataqueue[64] __attribute__((section(".kernel_data_CLS_ALL_PRC1"),nocommon));

static DTQMB _kernel_dtqmb_DTQID_tDataqueue_rProcessor2Symmetric_RPCPlugin__1_Channel_Dataqueue[64] __attribute__((section(".kernel_data_CLS_ALL_PRC2"),nocommon));

const DTQINIB _kernel_dtqinib_table[TNUM_DTQID] = {
	{ (TA_NULL), (64), _kernel_dtqmb_DTQID_tDataqueue_rProcessor1Migratable_RPCPlugin__0_Channel_Dataqueue },
	{ (TA_NULL), (64), _kernel_dtqmb_DTQID_tDataqueue_rProcessor2Symmetric_RPCPlugin__1_Channel_Dataqueue }
};

static DTQCB _kernel_dtqcb_DTQID_tDataqueue_rProcessor1Migratable_RPCPlugin__0_Channel_Dataqueue __attribute__((section(".kernel_data_CLS_ALL_PRC1"),nocommon));
static DTQCB _kernel_dtqcb_DTQID_tDataqueue_rProcessor2Symmetric_RPCPlugin__1_Channel_Dataqueue __attribute__((section(".kernel_data_CLS_ALL_PRC2"),nocommon));

DTQCB	*const _kernel_p_dtqcb_table[TNUM_DTQID] = {
	&_kernel_dtqcb_DTQID_tDataqueue_rProcessor1Migratable_RPCPlugin__0_Channel_Dataqueue,
	&_kernel_dtqcb_DTQID_tDataqueue_rProcessor2Symmetric_RPCPlugin__1_Channel_Dataqueue
};
...
const CYCINIB _kernel_cycinib_table[TNUM_CYCID] = {
	{ (TA_NULL), (intptr_t)(tTimeEventHandler_tCyclicNotifier_tExc08_eiCyclicHandler_0_arg), (NFYHDR)(tTimeEventHandler_tCyclicNotifier_tExc08_eiCyclicHandler_0_fp), (2000000), (0), 2, 0x3 },
	{ (TA_NULL), (intptr_t)(tTimeEventHandler_tCyclicNotifier_tExc08_eiCyclicHandler_1_arg), (NFYHDR)(tTimeEventHandler_tCyclicNotifier_tExc08_eiCyclicHandler_1_fp), (2000000), (0), 1, 0x3 }
};

static CYCCB _kernel_cyccb_CYCID_tCyclicHandler_rProcessor2Symmetric_CyclicHandler2 __attribute__((section(".kernel_data_CLS_ALL_PRC2"),nocommon));
static CYCCB _kernel_cyccb_CYCID_tCyclicHandler_rProcessor1Migratable_CyclicHandler __attribute__((section(".kernel_data_CLS_ALL_PRC1"),nocommon));

CYCCB	*const _kernel_p_cyccb_table[TNUM_CYCID] = {
	&_kernel_cyccb_CYCID_tCyclicHandler_rProcessor2Symmetric_CyclicHandler2,
	&_kernel_cyccb_CYCID_tCyclicHandler_rProcessor1Migratable_CyclicHandler
};
...
const ALMINIB _kernel_alminib_table[TNUM_ALMID] = {
	{ (TA_NULL), (intptr_t)(tTimeEventHandler_tAlarmNotifier_tExc08_eiAlarmHandler_0_arg), (NFYHDR)(tTimeEventHandler_tAlarmNotifier_tExc08_eiAlarmHandler_0_fp), 2, 0x3 },
	{ (TA_NULL), (intptr_t)(tTimeEventHandler_tAlarmNotifier_tExc08_eiAlarmHandler_1_arg), (NFYHDR)(tTimeEventHandler_tAlarmNotifier_tExc08_eiAlarmHandler_1_fp), 1, 0x3 }
};

static ALMCB _kernel_almcb_ALMID_tAlarmHandler_rProcessor2Symmetric_AlarmHandler2 __attribute__((section(".kernel_data_CLS_ALL_PRC2"),nocommon));
static ALMCB _kernel_almcb_ALMID_tAlarmHandler_rProcessor1Migratable_AlarmHandler __attribute__((section(".kernel_data_CLS_ALL_PRC1"),nocommon));

ALMCB	*const _kernel_p_almcb_table[TNUM_ALMID] = {
	&_kernel_almcb_ALMID_tAlarmHandler_rProcessor2Symmetric_AlarmHandler2,
	&_kernel_almcb_ALMID_tAlarmHandler_rProcessor1Migratable_AlarmHandler
};
