...
#define tSemaphore_CB_ptab           tSemaphore_INIB_ptab
...
extern tSemaphore_INIB  *const tSemaphore_INIB_ptab[];
...
#define tSemaphore_N_CELL           (4)  /*  number of cells  #_NCEL_# */
